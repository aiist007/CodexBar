...
> | 🔐 **安全性增强** | 优化 Keychain 访问机制：预检避免不必要弹窗、智能浏览器过滤减少授权提示、凭证缓存减少频繁访问、支持完全禁用 Keychain 访问（设置 → 高级） |
...
<img width="614" height="2096" alt="image" src="https://github.com/user-attachments/assets/c4389722-f668-466c-9862-885dd44eca04" />
